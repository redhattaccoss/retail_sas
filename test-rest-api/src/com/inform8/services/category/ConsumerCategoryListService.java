...
public class ConsumerCategoryListService extends Service {
	public List<Category> getAll(){
		String result = this.load(StaticConfig.host+"/rest.php?call=/category/consumer/list&enabledOnly=0");
	...
	public List<Category> getAllEnabled(){
		String result = this.load(StaticConfig.host+"/rest.php?call=/category/consumer/list");
		Gson gsonData = new Gson();
		//gsonData.fromJson(this.load("http://localhost/rest.php?call=/category/list"), Category.class);
		System.out.println(result);
		try{
