<?php
class EnableDisableRetailSubCategoryService extends Service{
	...
	protected function runImplementation(){
		...
		if ((trim($enable)!="")&&(trim($name)!="")){
			$subCategory = SubCategoryIQL::select()->where(SubCategoryIQL::$_TABLE, SubCategoryIQL::$NAME, "=", trim($name))->_and(SubCategoryIQL::$_TABLE, SubCategoryIQL::$WHOLESALEENABLED, "=", "0")->getFirst();
