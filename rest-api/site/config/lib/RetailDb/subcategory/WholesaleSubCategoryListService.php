<?php
class WholesaleSubCategoryListService extends Service{
	...
	protected function runImplementation(){
		...
		if ($setting->getEnabledOnly()=="1"){
			$categories = SubCategoryIQL::select()->where(SubCategoryIQL::$_TABLE, SubCategoryIQL::$WHOLESALEENABLED, "=", "1")->_and(SubCategoryIQL::$_TABLE, SubCategoryIQL::$ENABLED, "=", "1")->get();
		}else{
			$categories = SubCategoryIQL::select()->where(SubCategoryIQL::$_TABLE, SubCategoryIQL::$WHOLESALEENABLED, "=", "1")->get();
		}
